...
function renderHome(){
 refresh();
 const w=state.tasks.filter(t=>t.type==="weekly"),s=state.tasks.filter(t=>t.type==="short");
 $("#app").innerHTML=
...
function renderCalendar(){
 ...
 <div class="section">
   <div class="section-head"><b class="section-title">あと何日の内容</b><button class="link" id="addCD">追加</button></div>
