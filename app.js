...
injectedStyl.day-number-row{display:flex;align-items:center;gap:3px;min-width:0;width:100%;overflow:hidden}.countdown-inline{display:inline-block;flex:1;min-width:0;margin:0;padding:0;background:transparent;border:0;border-radius:0;color:#555;font-size:11px;font-weight:400;line-height:1.2;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;vertical-align:middle;text-align:left}e.textContent=`
